        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">IELTS - International English Language Testing System</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">IELTS - International English Language Testing System</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">IELTS - International English Language Testing System</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">CSBM Campus provides a thorough IELTS curriculum to help students improve their language skills. The curriculum combines cutting-edge tools, 
                        experienced assistance, and a welcoming learning atmosphere. It covers every area of the IELTS exam, such as listening, reading, writing, and speaking. 
                        Students are given individual tutoring, sample assessments, and feedback. The committed educators assist students in achieving their targeted IELTS score.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/languages/ielts.png" alt="Image">
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            ...
                            <h4 class="text-primary">30 Hours/ 20 Hours</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
