...
<head>
    <meta charset="utf-8">
    <title>TOEFL - Test of English as a Foreign Language</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">TOEFL - Test of English as a Foreign Language</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">TOEFL - Test of English as a Foreign Language</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">TOEFL - Test of English as a Foreign Language</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The TOEFL program offers dynamic lessons focusing on essential English skills like reading, listening, speaking, and writing. It uses authentic materials 
                        and simulates real exam conditions to enhance test-taking abilities. Students receive personalized feedback and targeted strategies and engage in interactive sessions 
                        and simulated exams to build confidence. This program aims to help students excel in the exam and master English for academic and professional success.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/languages/toefl.png" alt="Image">
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            ...
                            <h4 class="text-primary">20 Hours</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                ...
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            <h5>Intake(s): </h5>
                            <h4 class="text-primary">Monthly</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
