...
<head>
    <meta charset="utf-8">
    <title>Practical English Communication</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">PRACTICAL ENGLISH COMMUNICATION</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">PRACTICAL ENGLISH COMMUNICATION</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Practical English Communication</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Practical English Communication program aims to equip participants with the essential language skills needed for success in personal and 
                        professional contexts. By focusing on practical communication, cultural awareness, and real-life situations, this program will empower individuals to 
                        confidently engage in English Language environments.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/languages/english.png" alt="Image">
                </div>
