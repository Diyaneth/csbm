...
<head>
    <meta charset="utf-8">
    <title>Public Speaking And Presentation Skills For Professionals</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">PUBLIC SPEAKING AND PRESENTATION SKILLS FOR PROFESSIONALS</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">PUBLIC SPEAKING AND PRESENTATION SKILLS FOR PROFESSIONALS</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Public Speaking And Presentation Skills For Professionals</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Public Speaking and Presentation Skills for Professionals program aims to improve communication skills and reduce anxiety in public speaking. 
                        It offers a comprehensive curriculum, interactive workshops, practice sessions, and personalized feedback to help participants excel in both professional and
                         personal communication settings</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/languages/public.png" alt="Image">
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            ...
                            <h4 class="text-primary">3 months</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
