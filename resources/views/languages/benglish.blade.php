...
<head>
    <meta charset="utf-8">
    <title>Business English For Job Seekers</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Business English For Job Seekers</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Business English For Job Seekers</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Business English For Job Seekers</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Business English for Job Seekers program is an 8-week course that equips job seekers with language and communication skills for success in the 
                        job market. It combines language instruction with practical career content, fostering confidence and success in interviews and professional environments.
                        </p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/languages/benglish.png" alt="Image">
                </div>
