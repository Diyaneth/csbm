...
<head>
    <meta charset="utf-8">
    <title>Practical Diploma in Mental Health</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Practical Diploma in Mental Health</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Practical Diploma in Mental Health</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Practical Diploma in Mental Health</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Practical Diploma in Mental Health is a program that equips individuals with the skills and knowledge to navigate the complex mental health 
                        landscape. It provides a deep understanding of mental health disorders, their causes, and evidence-based treatment approaches. Students learn theoretical 
                        learning and practical training to assess and support individuals facing mental health challenges. The diploma covers critical topics like crisis intervention, communication strategies, and ethical considerations in mental health care. Graduates are well-prepared to make a positive impact in community settings, healthcare facilities, or support teams.
                        </p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/social/mental.png" alt="Image">
                </div>
