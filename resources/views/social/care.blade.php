...
<head>
    <meta charset="utf-8">
    <title>Certificate in Care Giver</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Certificate in Care Giver</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Certificate in Care Giver</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Certificate in Care Giver</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Practical Certificate in Care Giver is a comprehensive program that equips individuals with essential skills for a rewarding career in 
                        providing care. These programs cover healthcare fundamentals, communication skills, and specialized caregiving techniques. Participants gain a deep
                         understanding of physical, emotional, and social aspects of caregiving, and gain practical experience through hands-on training. Upon completion, 
                         graduates hold a recognized qualification, opening doors to fulfilling roles in healthcare and social service settings.
                        </p>

                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/social/care.png" alt="Image">
                </div>
                ...
                <div class="col-lg-5">
                    <b>
                        -Communication in Care Giving<br>
                        -Attend Domestic Affairs of the Client<br>
                        -Maintenance of Personal Hygienic Care<br>
                        -Maintenance of the Nutritional Status of the Client<br> 
                    </b>
                </div>

                <div class="col-lg-7">
                    <b>
                        -Basic Languages – English and One Other Foreign Language<br> 
                        -Basic Competencies for Work<br> 
                        -Personal Grooming, Personal Health and Hygiene<br> 
                    </b>
                </div>
