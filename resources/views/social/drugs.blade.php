...
<head>
    <meta charset="utf-8">
    <title>Advanced Certificate in Drugs Law Enforcement</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Advanced Certificate in Drugs Law Enforcement</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Advanced Certificate in Drugs Law Enforcement</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Advanced Certificate in Drugs Law Enforcement</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The primary goal of the Advanced Certificate in Drug Law Enforcement course is to provide training in specialized investigating techniques by 
                        focusing on drug trafficking in the region and the management principles of techniques. The training present skills necessary to plan, organize, and operate 
                        in the drug enforcement sector.
                        </p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/social/drugs.png" alt="Image">
                </div>
