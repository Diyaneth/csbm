...
<head>
    <meta charset="utf-8">
    <title>Higher Diploma in Sports & Exercise Science</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Higher Diploma in Sports & Exercise Science</h1>
                    <a href="{{url('index')}}" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{url('courses')}}" class="h5 text-white">Faculties</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{url('social')}}" class="h5 text-white">Programs</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Higher Diploma in Sports & Exercise Science</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Higher Diploma in Sports & Exercise Science</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Higher Diploma in Sports & Exercise Science is a comprehensive program that equips students with knowledge and practical skills for a 
                        successful career in sports and exercise science. It integrates scientific principles with practical applications, preparing graduates to assess and enhance 
                        athletic performance, and emphasizes critical thinking and problem-solving skills.
                        </p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/social/sports.png" alt="Image">
                </div>
                ...
                <div class="col-lg-5">
                <b>         -Principles of Sports Administration<br>
                            -Sports Governance <br>
                            -Organizations in Sports<br>
                            -Structure of Sports Administration<br> 
                            -Law and Ethics in Sports Administration<br> 
                            -Research methods in Sports Administration<br> 
                            -Managerial Accounting and Finance Management in Sports Administration<br> 
                            </b>
                </div>
                <div class="col-lg-7">
                <b>
                -Sports Psychology<br> 
                            -Marketing and Media Relations in Sports Administration<br> 
                            -Human Resource Management and Facility Design in Sports Administration<br> 
                            -Event Management in Sports Administration<br>  
                            -Leadership in Sports Administration<br>
                            -Research Project in Sports Administration<br>
                            -Fundamentals of small business management<br></b>
                </div>
                ...
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            ...
                            <h4 class="text-primary">6 months</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
