...
<head>
    <meta charset="utf-8">
    <title>Pedagogy in Early Childhood & Primary Education</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Pedagogy in Early Childhood & Primary Education</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Pedagogy in Early Childhood & Primary Education</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Pedagogy in Early Childhood & Primary Education</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Early Childhood and Primary Education Program offers a comprehensive foundation for aspiring educators, covering holistic development, 
                        pedagogy, classroom management, curriculum design, guidance, and counselling. Students gain practical skills through placements in teaching children aged 
                        0 to 12 years. The program aims to establish a solid foundation for children, preparing them to provide diverse teaching styles, stimulate their brains, 
                        and engage in both indoor and outdoor learning.
                        </p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/social/pedagogy.png" alt="Image">
                </div>
