...
<head>
    <meta charset="utf-8">
    <title>Executive Certificate in English & IT</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Executive Certificate in English & IT</h1>
                    <a href="{{url('index')}}" class="h5 text-white">Home</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{url('courses')}}.html" class="h5 text-white">Faculties</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="{{url('ICT')}}" class="h5 text-white">Programs</a>
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Executive Certificate in English & IT</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Executive Certificate in English & IT</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Certificate in English & IT is a program that combines language learning with practical IT applications to prepare students 
                        for the globalized digital landscape. It focuses on developing strong English skills through reading, writing, and communication modules, while 
                        providing hands-on experience in IT essentials like software applications, data management, and digital communication tools. This versatile skill 
                        set equips students with essential IT competencies, preparing them for diverse professional opportunities in the modern workforce.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/ICT/englishC.png" alt="Image">
                </div>
