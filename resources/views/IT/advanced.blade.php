...
<head>
    <meta charset="utf-8">
    <title>Advanced Microsoft Excel Skills for Professionals: Mastering Advanced Functions for Professional Growth</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Advanced Microsoft Excel Skills for Professionals: Mastering Advanced Functions for Professional Growth</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Advanced Microsoft Excel Skills for Professionals: Mastering Advanced Functions for Professional Growth</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Advanced Microsoft Excel Skills for Professionals: Mastering Advanced Functions for Professional Growth</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">Microsoft Excel isn't just for arranging data. It gives users the tools to interrogate data to find valuable new insights. 
                        Spreadsheet software remains as one of the most ubiquitous pieces of software used in workplaces across the world. Learning confidently 
                        to operate this software means adding a highly valuable asset to organizational efficiency and effectiveness. From this work- shop, 
                        participants will learn ways to make your job easier and increase the sophistication of your data reporting and analyzing.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/ICT/excel.png" alt="Image">
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            ...
                            <h4 class="text-primary">1 month</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
