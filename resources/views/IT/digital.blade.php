...
<head>
    <meta charset="utf-8">
    <title>Executive Certificate In Digital Marketing</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Executive Certificate In Digital Marketing</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Executive Certificate In Digital Marketing</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Executive Certificate In Digital Marketing</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Executive Certificate in Digital Marketing program is designed for professionals seeking to master the digital landscape. It covers 
                        six intensive modules, including strategic planning, data-driven decision-making, and using cutting-edge tools. Participants learn about social media, 
                        content optimization, and SEO, and gain industry-expert insights. The program equips participants with a comprehensive understanding of digital marketing 
                        strategies for impactful results.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/ICT/digital.png" alt="Image">
                </div>
