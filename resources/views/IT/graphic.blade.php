...
<head>
    <meta charset="utf-8">
    <title>Diploma In Graphic Design</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Diploma In Graphic Design</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Diploma In Graphic Design</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Diploma In Graphic Design</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Graphic Design Diploma program offers a comprehensive program that combines artistic finesse with technical expertise. 
                        It covers principles of visual communication, typography, and colour theory, and hands-on projects using Adobe Creative Suite. Students 
                        learn branding, layout design, and illustration, and gain insights into design trends. Experienced instructors guide students through 
                        real-world scenarios, preparing them for a dynamic career in graphic design. Elevate your portfolio and set the stage for a visually impactful future.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/ICT/graphic.png" alt="Image">
                </div>
