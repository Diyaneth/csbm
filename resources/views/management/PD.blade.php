        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Continuous Professional Development Program</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Continuous Professional Development Program</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Continuous Professional Development Program</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Continuous Professional Development Program is a structured course that gives professionals in their respective industries with 
                        continual learning opportunities. It blends academic and practical knowledge to ensure a well-rounded skill set. The program, which is led by 
                        industry leaders and educators, promotes collaborative learning through workshops, seminars, and interactive online modules. It emphasizes on 
                        adaptability and relevance, meeting the changing demands of professionals looking to flourish in today's competitive environment.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/pd.png" alt="Image">
                </div>
