...
<head>
    <meta charset="utf-8">
    <title>Advanced Certificate in International Trade Management</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Advanced Certificate in International Trade Management</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Advanced Certificate in International Trade Management</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Advanced Certificate in International Trade Management</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Advanced Certificate in International Trade Management is a comprehensive program that covers fundamentals of global trade, export and 
                        import procedures, market analysis, trade finance, logistics and supply chain management, legal and regulatory compliance, cultural sensitivity, and 
                        trade promotion and marketing. It also covers market research, risk mitigation, and compliance with international laws and regulations.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/trade.png" alt="Image">
                </div>
