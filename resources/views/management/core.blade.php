...
<head>
    <meta charset="utf-8">
    <title>CORE Program (Infer Consulting | New Zealand)</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">CORE Program (Infer Consulting | New Zealand)</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">CORE Program (Infer Consulting | New Zealand)</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">CORE Program (Infer Consulting | New Zealand) </h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The CORE training program is a modular executive development course designed for mid and senior professionals, 
                        utilizing psychological theory to equip participants with evidence-based resources to enhance their skills, work effectively, 
                        and boost productivity and effectiveness.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/CORE Program.png" alt="Image">
                </div>
