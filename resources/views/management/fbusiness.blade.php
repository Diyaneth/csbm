...
<head>
    <meta charset="utf-8">
    <title>QUALIFI Level 3 Diploma in Business Management (Foundation)</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">QUALIFI Level 3 Diploma in Business Management (Foundation)</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">QUALIFI Level 3 Diploma in Business Management (Foundation)</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">QUALIFI Level 3 Diploma in Business Management (Foundation)</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">This Business Management program offers a comprehensive introduction to business principles, covering topics like organizational behaviour, 
                        marketing, financial management, and ethics. It equips students with practical insights into strategic decision-making and problem-solving, preparing 
                        them for future success in the business world. The curriculum integrates theoretical knowledge with real-world case studies, fostering critical thinking 
                        and analytical skills. Graduates are well-equipped to navigate modern business environments and contribute effectively to organizational growth and 
                        sustainability.</p>
                        <h5 class="mb-2">For more details about QUALIFI</h5>
                        <a href="https://qualifi.net/qualifi-level-3-diploma-in-business-management" class="btn btn-primary py-2 px-4 ms-3">More Details</a><br><br>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/fbusiness.png" alt="Image">
                </div>
