...
<head>
    <meta charset="utf-8">
    <title>Taxation for Professionals & Personal Development</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Taxation for Professionals & Personal Development</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Taxation for Professionals & Personal Development</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Taxation for Professionals & Personal Development</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The program aims to equip professionals with tax expertise and personal growth. It covers advanced tax tactics, regulatory compliance, 
                        and new trends, preparing them for the ever-changing tax world. Practical case studies, workshops, and discussions enhance analytical and decision-making 
                        abilities. The curriculum also emphasizes personal growth, including modules on communication, leadership, and time management. Students will be well-rounded 
                        tax professionals ready for success in both their employment and personal lives.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/taxation.png" alt="Image">
                </div>
