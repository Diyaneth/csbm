...
<head>
    <meta charset="utf-8">
    <title>Executive Development Program (Mini MBA)</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Executive Development Program (Mini MBA)</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Executive Development Program (Mini MBA)</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Executive Development Program (Mini MBA)</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Mini MBA Program aims to enhance business skills and leadership capabilities in high-potential executives, providing conceptual 
                        frameworks for strategy setting, decision-making, and effective leadership, while equipping them with essential management skills and techniques.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/minimba.png" alt="Image">
                </div>
