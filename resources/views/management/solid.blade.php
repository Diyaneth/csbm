...
<head>
    <meta charset="utf-8">
    <title>Advanced Certificate in Solid Waste Management</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Advanced Certificate in Solid Waste Management</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Advanced Certificate in Solid Waste Management</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Advanced Certificate in Solid Waste Management</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">After analysing the waste management in Sri Lanka, we, at CSBM Campus and the Waste Management Authority, have identified immense 
                        opportunities to build the sector with hybrid training and development programs. This is based on our mutual knowledge and wisdom to enhance 
                        the capacity of members who are related to solid waste management to achieve vistas of prosperity which introduced by the government of Sri Lanka.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/solid.png" alt="Image">
                </div>
