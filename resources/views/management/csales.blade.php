...
<head>
    <meta charset="utf-8">
    <title>Executive Certificate in Sales & Marketing</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Executive Certificate in Sales & Marketing</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Executive Certificate in Sales & Marketing</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Executive Certificate in Sales & Marketing</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Executive Certificate in Sales & Marketing is a program designed for professionals seeking to enhance their strategic 
                        skills in the competitive business environment. It combines advanced sales methodologies with innovative marketing strategies, providing
                         a comprehensive understanding of consumer behaviour, market trends, and effective communication. Participants learn advanced sales techniques,
                          digital marketing, and leadership skills for driving organizational growth. The program includes real-world case studies and interactive workshops,
                           empowering graduates with a strategic mindset and skills for contemporary sales and marketing leadership roles.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/sales.png" alt="Image">
                </div>
