...
<head>
    <meta charset="utf-8">
    <title>Executive Diploma in Sales & Marketing</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">Executive Diploma in Sales & Marketing</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">Executive Diploma in Sales & Marketing</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">Executive Diploma in Sales & Marketing</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The Executive Diploma in Sales & Marketing is a program designed for experienced professionals to enhance their business 
                        success. It combines advanced sales methodologies and strategic marketing principles, providing insights into customer-centric strategies, 
                        effective team leadership, and digital marketing trends. Practical exercises and case studies enhance decision-making abilities, fostering 
                        a holistic approach to sales and marketing management. Graduates with this prestigious diploma can implement innovative strategies and lead 
                        their organizations in the competitive business landscape.<br></p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/Dsales.png" alt="Image"> 
                </div>
